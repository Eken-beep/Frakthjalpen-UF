	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/addinterested/_server.ts.js'))
			},
			{
				id: "/api/logout",
				pattern: /^\/api\/logout\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/logout/_server.ts.js'))
			},
			{
				id: "/api/modify_post",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/modify_post/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/verify_payment/_server.ts.js'))
			},
			{
				id: "/login",
				pattern: /^\/login\/?$/,
